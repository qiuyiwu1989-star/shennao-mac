...
- `Sources/LuyinbiApp/` — 界面层：内容（台账）/ 设备 两块
...
**浏览、播放、认人、本地搜索、用 Mac 麦克风录音——都不做。**
网页已经做了这些，原生复刻只会长期落后于那份实现。这个 App 唯一
做得比别处好的事，是它插着电、开着蓝牙、就摆在录音笔旁边，
适合安安静静守一整天。

所以右侧详情是**台账**不是阅读器：只回答「这条走到哪一步了、
卡住的话卡在哪」，要看内容点「在深脑打开」。
